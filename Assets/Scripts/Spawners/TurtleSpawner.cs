...
public class TurtleSpawner : MonoBehaviour {
	...
	void Spawn() {
		//spawns a turtle with randomised y values
		...
		Instantiate(turtle, here + new Vector3(0f, Random.Range(here.y + c.orthographicSize, here.y - c.orthographicSize)), gameObject.transform.rotation);
	}
